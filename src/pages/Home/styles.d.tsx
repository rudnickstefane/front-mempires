...
import backSupplier from '../../assets/images/shape-47.jpg';
...
export const SectionSupplier = styled.div`
    background: url(${backSupplier}) repeat center;
    width: 100%;
...
export const SectionPersonal = styled.div`
    background: url(${personal}) repeat center left;
    background-position-y: -5rem;
    width: 100%;

    @media (max-width: 768px) {
        background: url(${personal}) repeat center;
    }
`;

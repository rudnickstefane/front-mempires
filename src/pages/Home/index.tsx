...
import studentGym from '../../assets/images/studentGym.png';
...
export default function Home() {
    const { text, description, fade } = useTextSwitcher([
        {
            text: 'Alunos',
            description: <span>Encontre academias <b className='font-bold'>perto de você</b>, aproveite <b className='font-bold'>descontos exclusivos</b> e assine seu plano sem complicações.</span>
        },
        {
            text: 'Academias',
            description: <span>Acesse um sistema <b className='font-bold'>completo</b> para gestão de academias, com <b className='font-bold'>programas de incentivo</b> e treinos personalizados.</span>
        },
        {
            text: 'Fornecedores',
            description: <span>Conecte-se com <b className='font-bold'>academias de todo o Brasil</b> e expanda seu alcance.</span>
        },
        {
            text: 'Nutricionistas',
            description: <span>Junte-se à nossa <b className='font-bold'>comunidade</b> de nutricionistas e tenha acesso direto aos alunos das academias.</span>
        },
        {
            text: 'Personal Trainers',
            description: <span><b className='font-bold'>Expanda</b> sua rede de alunos e ofereça treinos personalizados direto na plataforma.</span>
        }
    ], 5000);
    ...
    return (
        <>
            <Header />
            <Box className='w-full flex absolute md:top-[10rem] top-[8rem] right-[3rem]'>
                <Box className='md:w-[675px] w-[130px]'></Box>
                <Box className='flex flex-col text-white w-[675px]'>
                    <Box>
                        <DestaqueTitle className="bg-primary text-white">Ser Flex é fácil</DestaqueTitle>
                        <Box className='flex flex-col'>
                            <Box className="text-[24px] flex flex-row">Benefícios exclusivos <Box className='text-[17px] ml-2 mt-2'>para</Box></Box>
                            <Box className={`text-[34px] mb-10 transition-opacity duration-500 ${fade ? 'opacity-100' : 'opacity-0'}`}>{text}</Box>
                            <Typography className={`h-[51px] !text-[17px] !font-light !text-[#cbcbcb] transition-opacity duration-500 ${fade ? 'opacity-100' : 'opacity-0'}`}>
                                {description}
                            </Typography>
                            <Button
                                variant="contained"
            ...
            <Box className="py-10 shadow-lg rounded-lg bg-white absolute w-[70%] top-[33rem] right-[3rem] p-[2rem]">
                <Box className="container mx-auto">
                    <DestaqueTitle className="bg-primary text-white">Exclusivo</DestaqueTitle>
                    <Box className="text-3xl text-black">Programas de Incentivo</Box>
                    <Box className="mt-5">
                        <Box>Descubra nossos <b>incentivos exclusivos</b> para alunos, academias e fornecedores!</Box>
                        <Box className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
                            <Box className="flex flex-col items-center">
                                <Box className="color-primary text-4xl mb-4">
                                    <CiDiscount1 />
                                </Box>
                                <Box className="text-lg font-semibold mb-2 text-black">Descontos em Produtos</Box>
                                <Box className="text-center text-gray-600">Aproveite descontos especiais em produtos de nossos parceiros.</Box>
                            </Box>
                            <Box className="flex flex-col items-center md:mt-0 mt-4">
                                ...
                                <Box className="text-center text-gray-600">Estratégias para reativar alunos ausentes e manter sua matrícula ativa.</Box>
                            </Box>
                            <Box className="flex flex-col items-center md:mt-0 mt-4">
                                <Box className="color-primary text-4xl mb-4">
                                    <PiHeartbeat />
                                ...
                                <Box className="text-center text-gray-600">Programas de bem-estar para incentivar hábitos saudáveis.</Box>
                            </Box>
                        </Box>
                        <Button
            ...
            <Box className='md:mt-[23rem] mt-[44rem]'>
                <Box className='m-10 flex flex-row justify-center'>
                    ...
                    <Box className='relative z-0'>
                        <DestaqueTitle className="bg-primary text-white">Ei Academia!</DestaqueTitle>
                ...
                <Box className='w-full bg-primary h-[15rem] font-bold text-white text-[2.4rem] flex items-center justify-center relative z-0'>
                ...
                <Box className='mt-20 flex flex-row justify-center w-full'>
                    <Box className='w-[405px] mr-10 md:mt-0 mt-48'>
                        <Box className='bg-primary w-[1rem] md:h-[20rem] h-[10rem] absolute mt-5'></Box>
                        <Box className='bg-primary w-[.5rem] md:h-[10rem] h-[20rem] absolute mt-14 -ml-5'></Box>
                        <Box className='flex flex-col items-center'>
                    ...
                    <Box className='w-[675px]'>
                        <Box>
                            <DestaqueTitle className="bg-primary text-white">Vem com a nutri!</DestaqueTitle>
                ...
                <SectionSupplier className='flex flex-col justify-center w-full py-20'>
                    <Box className='w-full flex flex-col justify-center items-center'>
                        <DestaqueTitle className="bg-primary text-white">Fornecedores</DestaqueTitle>
                ...
                <Box className='mt-20 flex flex-row justify-center w-full'>
                    <Box className='w-[200px] mr-10 md:mt-10 mt-20'>
                        <img src={studentGym} className='mr-5' />
                    </Box>
                    <Box className='w-[675px]'>
                        <Box>
                            <DestaqueTitle className="bg-primary text-white">Você, Aluno</DestaqueTitle>
                            <Box className='text-black text-[2.4rem] mb-5'>
                                Encontre a <span className='font-bold color-primary'>academia mais próxima</span> de você!
                            </Box>
                            <Typography className='text-[1.2rem]'>
                                Descubra academias perto de você, confira detalhes, planos aceitos, formas de pagamento, e feche seu plano diretamente pelo site ou app — tudo de forma rápida e fácil.
                            </Typography>
                            <Button
                                variant="contained"
                                href="/cadastro/aluno"
                ...
                <Box className='w-full bg-primary md:h-[10rem] h-[15rem] font-bold text-white text-[2.4rem] flex items-center justify-center relative z-0 mt-20'>
                ...
                <SectionPersonal>
                    <Box className='w-full flex flex-row justify-center items-center md:h-[700px]'>
                        <Box className='w-[530px] mr-10 md:mt-0 mt-48 md:flex flew-row h-full md:pt-[12rem] pt-[25rem] hidden'>
                            <Box className='bg-primary w-[1rem] h-[10rem] mr-2 skew-x-[5deg]'></Box>
                            <img src={indexPersonal} className='w-[500px]' />
                            <Box className='bg-primary w-[1rem] md:h-[10rem] h-[20rem] mt-32 ml-2 skew-x-[5deg]'></Box>
                        </Box>
                        <Box className='w-[675px] md:mt-0 my-10 md:m-0 m-10'>
                            <DestaqueTitle className="bg-primary text-white">Personal Trainer</DestaqueTitle>

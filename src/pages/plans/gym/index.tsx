...
import { useSignatureForm } from "../../../modules/private/portal/hooks";
...
export const GymPlans = () => {
  ...
  const { plans, selectedPlan, setSelectedPlan } = useSignatureForm({
    enqueueSnackbar,
  });
        ...
        <Box className="flex md:flex-row flex-col md:mt-10 mt-16">
          <Box className="shadow-2xl rounded-lg p-6 flex flex-col items-center w-[277px] transition-transform duration-500 hover:scale-105 cursor-pointer bg-[#F6F6F7] text-[#7B7E86]">
            ...
            <Box className="flex flex-row color-primary">
              ...
              <Typography className="!text-[40px] !font-bold !ml-1">
                {currentPlan.monthly}
              </Typography>
            ...
            <Box className="flex flex-col items-center justify-center h-full">
              <Typography className="flex flex-row items-center !mt-10 !text-[15px]">
                Comece hoje mesmo a transformar a gestão da sua academia!
              </Typography>
            </Box>
          ...
          <Box className="shadow-2xl rounded-lg mx-10 p-6 flex flex-col items-center w-[277px] transition-transform duration-500 scale-105 cursor-pointer bg-[#000000c7] text-white md:mt-0 mt-16">
            ...
            <Box className="flex flex-row">
              ...
              <Typography className="!text-[35px] !font-bold !ml-1">
                {currentPlan.quarterly}
              </Typography>
              <Box className="flex flex-row items-end">
                <Typography className="!mb-5 !text-[14px]">
                  /trimestre
                </Typography>
              </Box>
            </Box>
            <Divider className="!my-5 w-full bg-[#e2e2e4]" />
            <Box className="flex flex-col items-center justify-center h-full">
              <Typography className="flex flex-row items-center !text-[23px] !font-bold">
                10% de Desconto
              </Typography>
              <Typography className="flex flex-row items-center !mb-5 !text-[15px]">
                Até 3x sem juros no cartão
              </Typography>
              <Box className="flex flex-col text-[15px] items-center !mt-10">
                Aproximadamente{" "}
                <Typography className="!font-bold !mt-1">
                  R$ {currentPlan.quarterlyMonthly}
                </Typography>{" "}
                mensais
              </Box>
            </Box>
          ...
          <Box className="shadow-2xl rounded-lg p-6 flex flex-col items-center w-[277px] transition-transform duration-500 hover:scale-105 cursor-pointer bg-[#F6F6F7] text-[#7B7E86] md:mt-0 mt-24">
            ...
            <Divider className="!my-5 w-full bg-[#E2E2E4]" />
            <Box className="flex flex-col items-center justify-center h-full">
              <Typography className="flex flex-row items-center !text-[23px] !font-bold color-primary">
                20% de Desconto
              </Typography>
              <Typography className="flex flex-row items-center !mb-5 !text-[15px]">
              ...
              <Box className="flex flex-col text-[15px] items-center !mt-10">
                Aproximadamente{" "}
                <Typography className="!font-bold color-primary !mt-1">
                  R$ {currentPlan.yearlyMonthly}
                </Typography>{" "}
                mensais
              </Box>
            </Box>
      ...
      <Box className="p-5 pb-[4rem]">
        <Box className="w-full flex flex-col">
          <Box className="w-full py-6 flex flex-col items-center">
            <Box className="flex flex-row md:text-[2.5rem] text-[1.5rem] text-black">
              A{" "}
              <Typography className="!mx-[10px] !font-bold md:!text-[2.5rem] !text-[1.5rem] color-primary">
                gestão
              </Typography>{" "}
              perfeita está a um passo de você!
            </Box>
            <Typography className="md:!text-[1.1em] !text-[.75em] !mt-1">
              Escolha o plano ideal para sua academia e aproveite todos os
          ...
          <Box className="w-full pb-20 flex flex-col items-center mt-10">
            <Box className="flex md:flex-row flex-col md:mt-10 mt-16">
              <Box className="shadow-2xl rounded-lg p-6 flex flex-col items-center w-[277px] transition-transform duration-500 hover:scale-105 cursor-pointer bg-[#F6F6F7] text-[#7B7E86]">
                ...
                <Box className="text-[25px] text-black mt-5">
                ...
                <Box className="flex flex-col w-[91%]">
                  {plans.Essential.features.map((feature, index) => (
                    ...
                    >
                      <FaRegCircleCheck className="mr-2 color-primary" />{" "}
                      {feature}
                    </Typography>
                  ))}
                </Box>
              ...
              <Box className="shadow-2xl rounded-lg mx-10 p-6 flex flex-col items-center w-[277px] transition-transform duration-500 scale-105 cursor-pointer bg-[#0c0f17] text-[#b2b8bf] md:mt-0 mt-16">
                ...
                <Box className="text-[25px] text-white">
                  {plans.Business.name}
                </Box>
                ...
                <Box className="flex flex-col justify-center w-[91%] h-full">
                  <Typography className="flex flex-row justify-center items-center !mb-3 !font-semibold">
                    {" "}
                    Tudo do Essential +
                  </Typography>
              ...
              <Box className="shadow-2xl rounded-lg p-6 flex flex-col items-center w-[277px] transition-transform duration-500 hover:scale-105 cursor-pointer bg-[#F6F6F7] text-[#7B7E86] md:mt-0 mt-24">
                ...
                <Box className="text-[25px] text-black">
                  {plans.Imaginative.name}
                </Box>
                <Box className="flex flex-row color-primary">
                  <Typography className="!text-[20px]">R$</Typography>
                  <Typography className="!text-[40px] !font-bold !ml-1">
                    {plans.Imaginative.monthly}
                  </Typography>
                  <Box className="flex flex-row items-end">
                    <Typography className="!mb-5">/mês</Typography>
                  </Box>
            ...
            <Collapse in={!!selectedPlan} timeout="auto" unmountOnExit>
              <Box className="mt-5 flex flex-row justify-evenly items-center">
                <Box className="rounded-3xl p-2 bg-[#f3f3f3]">
                  <Button
                    className={`flex flex-row !rounded-2xl !p-4 w-[10rem] !text-[1.1rem] ${
                      selectedPlan === "Essential"
                        ? "bg-secondary !text-white"
                        : "!bg-[#f3f3f3]"
                    }`}
                    style={{
                      color: selectedPlan === "Essential" ? "#fff" : "#08041b",
                    }}
                  ...
                  <Button
                    className={`flex flex-row !rounded-2xl !p-4 w-[10rem] !text-[1.1rem] !mx-2 ${
                      selectedPlan === "Business"
                        ? "bg-secondary !text-white"
                        : "!bg-[#f3f3f3]"
                    }`}
                    style={{
                      color: selectedPlan === "Business" ? "#fff" : "#08041b",
                    }}
                    sx={{ textTransform: "none" }}
                  ...
                  <Button
                    className={`flex flex-row !rounded-2xl !p-4 w-[10rem] !text-[1.1rem] ${
                      selectedPlan === "Imaginative"
                        ? "bg-secondary !text-white"
                        : "!bg-[#f3f3f3]"
                    }`}
                    style={{
                      color:
                        selectedPlan === "Imaginative" ? "#fff" : "#08041b",
                    }}
                    sx={{ textTransform: "none" }}
          ...
          <Box ref={recursosRef}>
            <Box className="flex flex-row w-full p-10 pt-0">
              <Box className="shadow-2xl rounded-lg p-6 flex flex-col items-center w-full transition-transform duration-500 bg-[#F6F6F7] text-[#7B7E86] md:mt-0 mt-24">
                <Typography className="text-[#212121] text-center !my-5 !text-2xl">
                  Principais recursos de cada plano
                </Typography>
                <TableContainer>
                  <Table>
                    <TableHead>
                    ...
                    <TableBody>
                      ...
                      <TableRow>
                        ...
                        <TableCell align="center">
                          <FaRegCircleCheck className="color-primary mx-auto" />
                        </TableCell>
                        <TableCell align="center">
                          <FaRegCircleCheck className="color-primary mx-auto" />
                        </TableCell>

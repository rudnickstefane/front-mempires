...
import GymAdminClassesManagement from "./classes-gym-admin";
import GymAdminContributorsManagement from "./contributors-gym-admin";
import GymAdminFrequenciesManagement from "./frequencies-gym-admin";
import GymAdminGroupsManagement from "./groups-gym-admin";
import GymAdminHomeManagement from "./home-gym-admin";
import GymAdminHoursManagement from "./hours-gym-admin";
import GymAdminMarketplaceManagement from "./marketplace-gym-admin";
import GymAdminPlansManagement from "./plans-gym-admin";
import GymAdminStudentsManagement from "./students-gym-admin";
import GymAdminSuppliersManagement from "./suppliers-gym-admin copy";
import { GymAdminManagementType } from "./types/gym-admin.types";
import GymAdminUsersManagement from "./users-gym-admin";

const blockedTitles = ['Students', 'Classes', 'Suppliers', 'Contributors', 'Users', 'Groups'];
...
const subResources: ResourceBoxProps[] = [
    ...
    },
    {
        ...
        type: 'Email',
        name: 'E-mails',
        description: 'Modelos de <span class="color-primary">E-mails</span>',
    }
];
...
const renderComponents: { [key in GymAdminManagementType]: React.ComponentType } = {
    Home: GymAdminHomeManagement,
    Students: GymAdminStudentsManagement,
    Classes: GymAdminClassesManagement,
    Frequencies: GymAdminFrequenciesManagement,
    Plans: GymAdminPlansManagement,
    Marketplace: GymAdminMarketplaceManagement,
    Suppliers: GymAdminSuppliersManagement,
    Contributors: GymAdminContributorsManagement,
    Users: GymAdminUsersManagement,
    Groups: GymAdminGroupsManagement,
    Hours: GymAdminHoursManagement
};

export default function GymAdminManagement() {
    ...
    const [activeComponent, setActiveComponent] = useState<GymAdminManagementType>('Home'); // Controle para o componente ativo
    ...
    const handleResourceClick = (resource: ResourceBoxProps) => {
        ...
        if (resource.type && resource.type in renderComponents) {
            setActiveComponent(resource.type as GymAdminManagementType);
        }
    ...
    const handleSubResourceClick = (subResource: ResourceBoxProps) => {
        ...
        if (subResource.type && subResource.type in renderComponents) {
            setActiveComponent(subResource.type as GymAdminManagementType);
        }
    };

                    ...
                    <Box className='flex flex-row justify-between items-center'>
                        <Box>
                            ...
                            <Typography className='flex flex-row items-center !text-[.85rem] !mt-4'>
                                Suporte<MdKeyboardArrowRight className='mx-1.5' />Sugestões
                            </Typography>
                        </Box>
                        <Button
                    ...
                    <Box className="overflow-x-auto border border-neutral-300 rounded-lg w-full">
                        <TableContainer>
                            <Table>
                                ...
                                <TableBody>
                                {responseSuggestions?.findTickets && responseSuggestions?.findTickets.length > 0 ? (
                                    responseSuggestions?.findTickets.sort((a, b) => 
                                    ...
                                    >
                                        ...
                                        <TableCell className="max-w-[10rem]">
                                            <Box
                                                ...
                                                onClick={() => handleMoreDetails(ticket.ticketCode, 'SUGGESTION')}
                                                sx={{
                                                    transition: "transform 0.3s, background-color 0.3s",
                                                }}
                                            >

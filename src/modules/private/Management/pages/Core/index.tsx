                    ...
                    <Box className='w-full p-5 pb-0 pt-0'>
                        ...
                        <Tooltip title={'Informações da Empresa'} placement="right" arrow>
                            ...
                            >
                                ...
                                >
                                    <Typography className="whitespace-nowrap overflow-hidden text-ellipsis">iFlex</Typography>
                                    <Typography className="!font-light !text-[.9rem] whitespace-nowrap overflow-hidden text-ellipsis">Core Platform</Typography>
                                </Box>
                            </Button>
                        </Tooltip>
                    ...
                    <Box textAlign="center">
                        <Tooltip title={'Notificações'} placement="bottom" arrow>
                            ...
                            >
                                ...
                                {responseNotifications?.findNotifications && responseNotifications?.findNotifications?.length > 0 && (
                        ...
                        >
                            {responseNotifications?.findNotifications?.map((notification, index) => (
                                <MenuItem
                                    key={index}
                                    onClick={() => {
                                        setSelectedResource(null);

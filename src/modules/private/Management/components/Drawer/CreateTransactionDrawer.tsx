...
import { useCreateTransactionForm } from '../../hooks';
...
export const CreateTransactionDrawer = ({
  ...
  const {
    ...
    handleFinish,
    handleSelectChange,
  } = useCreateTransactionForm({ closeDrawer, enqueueSnackbar, data, refreshInternal });
            ...
            {(() => {
              switch (activeStep) {
                case 0:
                  return (
                    <>
                      <FormControl error={!!errors.typeError} required className='w-full'>
                        <InputLabel id="type">Tipo de Transação</InputLabel>
                        <Select
                          labelId="type"
                          id="type"
                          name="type"
                        ...
                        >
                          <MenuItem value="" disabled>Selecione o tipo da transação</MenuItem>
                        ...
                        {errors.typeError && <FormHelperText>{errors.typeError}</FormHelperText>}
                      </FormControl>

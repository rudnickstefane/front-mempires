...
export const SuggestionCreateDrawer = ({
  closeDrawer,
  enqueueSnackbar,
  refresh,
}: DrawerProps) => {
                    ...
                    <>
                      ...
                      <FormControl fullWidth>
                        <TextField
                          required
                          name='message'
                          placeholder='Conte mais sobre o que você gostaria de melhorar ou adicionar em nosso sistema.'
                          multiline
                          rows={4}

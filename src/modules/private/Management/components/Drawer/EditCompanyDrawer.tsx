...
export const EditCompanyDrawer = ({
  ...
  } = useEditCompanyForm({ closeDrawer, enqueueSnackbar, data, refresh });
                      ...
                      <Box className='flex flex-row items-center'>
                        <FormControl fullWidth>
                          <TextField
                            ...
                            disabled={Boolean(data?.findCompanyDetails.code)}
                          />
                        </FormControl>
                        <Tooltip
                          title={
                            <>
                              O CNPJ só pode ser alterado uma vez. Alterações subsequentes precisam ser solicitadas ao suporte.<br /><br />

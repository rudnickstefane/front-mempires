...
import { StepOneProps } from '../../../../../../pages/sign-up/gym/types';
import { useOneStepConfigGym } from '../hooks';

export const OneStepConfigGym = ({ formData, setFormData, errors, setErrors, handleContinue }: StepOneProps) => {
    const {
        selectedValue,
        ...
        handleDayChange,
        validateForm,
    } = useOneStepConfigGym(formData, setFormData, setErrors);
                        ...
                        <Box className='md:w-[100%] w-full mx-1'>
                            <FormControl error={!!errors.timeZoneError} required className='w-full'>
                                ...
                                >
                                    ...
                                    <MenuItem value="America/Noronha">(UTC-02:00) Horário de Fernando de Noronha (FNT)</MenuItem>
                                    <MenuItem value="America/Sao_Paulo">(UTC-03:00) Horário de Brasília (BRT)</MenuItem>
                                    <MenuItem value="America/Manaus">(UTC-04:00) Horário de Manaus (AMT)</MenuItem>
                                    <MenuItem value="America/Rio_Branco">(UTC-05:00) Horário de Rio Branco (ACT)</MenuItem>
                                </Select>
                    ...
                    <Box className='w-full flex flex-row'>
                        <Box className='w-full mx-1'>
                            <Box className='flex flex-col'>
                                {['Feriado', 'Domingo', 'Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sábado'].map(day => (
                                    <FormControlLabel
                                        className='w-[10%]'
                                        key={day}
                                        control={

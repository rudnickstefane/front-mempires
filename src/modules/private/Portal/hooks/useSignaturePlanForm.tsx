...
DrawerProps) => {
  ...
  const plans = {
    Essential: {
      ...
      description:
        "Plano inicial para academias, uma faísca para começar a gestão.",
      features: [
        "Alunos Ilimitados",
        "Check-in & Check-out",
        "Integrações",
    ...
    Business: {
      ...
      yearlyMonthly: 31.92,
      description:
        "Plano intermediário para academias, focado em negócios e crescimento.",
      features: ["Aplicativo", "Programas", "Relatórios Completos"],
    },
    Imaginative: {
      name: "Imaginative",
      monthly: 699.9,
      ...
      description:
        "Plano avançado para academias, com recursos completos para grandes operações.",
      features: [
  ...
  const handleFinish = async () => {
    if (validateForm()) {
      ...
      try {
        ...
        enqueueSnackbar("Assinatura efetuada com sucesso!", {
          variant: "success",
        });
        closeDrawer();
        ...
        if (attemptCount >= 5) {
          return enqueueSnackbar(
            "Erro ao assinar plano. Entre em contato com nosso suporte.",
            { variant: "error" }
          );
        }

        const genericError =
          "Ops! Algo deu errado ao processar assinatura do plano. Tente novamente!";

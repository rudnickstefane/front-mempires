...
import { useTicket } from "../../../../home/hooks";
        ...
        <>
          <Box className="flex flex-row justify-between items-center">
            ...
            <Button
              ...
              onClick={() => openDrawer("SuggestionCreate")}
            >
              Nova Sugestão
            </Button>
          </Box>
          ...
          <Box className="overflow-x-auto border border-neutral-300 rounded-lg w-full">
            <TableContainer>
              <Table>
                ...
                <TableBody>
                  {responseSuggestions?.findTickets &&
                  responseSuggestions?.findTickets.length > 0 ? (
                    responseSuggestions?.findTickets
                      .sort(
                        (a, b) =>
                      ...
                      .map((ticket, index) => (
                        ...
                        >
                          ...
                          <TableCell>STE-{ticket.ticketCode}</TableCell>
                          ...
                          <TableCell>
                            <Box textAlign="center">
                              <IconButton
                                ...
                                onClick={(event) =>
                                  handleOpenMore(event, ticket.ticketCode)
                                }
                                style={{
                                  backgroundColor: isMenuOpen(ticket.ticketCode)
                                    ? "#0000000a"
                                    : "",
                                }}
                              >
                              ...
                              <Menu
                                ...
                                onClose={() =>
                                  handleCloseMore(ticket.ticketCode)
                                }
                                slotProps={{
                                  paper: {
                                    sx: {

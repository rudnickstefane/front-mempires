          ...
          <Box className="overflow-x-auto border border-neutral-300 rounded-lg w-full">
            <TableContainer>
              <Table>
                ...
                <TableBody>
                  {responseUpdates?.findUpdates &&
                  responseUpdates?.findUpdates.length > 0 ? (
                    responseUpdates?.findUpdates
                      .sort(
                        (a, b) =>
                      ...
                      .map((update, index) => (
                        ...
                        >
                          ...
                          <TableCell>
                            <QueueBadge payment={update.impact} />
                          </TableCell>
                          <TableCell>
                            <Box textAlign="center">
                              <IconButton
                                ...
                                onClick={(event) =>
                                  handleOpenMore(event, update.updateCode)
                                }
                                style={{
                                  backgroundColor: isMenuOpen(update.updateCode)
                                    ? "#0000000a"
                                    : "",
                                }}
                              >
                              ...
                              <Menu
                                ...
                                onClose={() =>
                                  handleCloseMore(update.updateCode)
                                }
                                slotProps={{
                                  paper: {
                                    sx: {

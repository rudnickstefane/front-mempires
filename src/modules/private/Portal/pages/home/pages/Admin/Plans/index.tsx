      ...
      <Box className="overflow-x-auto max-h-[calc(100vh-60px)] p-5 pb-[4rem]">
        <Box className="flex flex-row w-full">
          <Box className="bg-white w-full rounded-3xl shadow-md p-5 border border-[#EAECF0]">
            <Box className="flex flex-row justify-between items-center">
              <Box>
                <Typography className="flex flex-row items-center !text-[2.25rem] text-[#212121]">
                  ...
                  Plano
                  <Box className="truncate max-w-[27vw] ml-3">
                    {" "}
                    {data.findPlans.name}
                  </Box>
                </Typography>
            ...
            <Box className="mt-5 border border-neutral-300 rounded-lg p-5">
              ...
              <>
                ...
                <Box className="grid grid-cols-[10rem,1fr]">
                  ...
                  <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                    {data?.findPlans.startDate
                      ? FormatDateTime(data.findPlans.startDate)
                      : ""}
                  </Typography>
                </Box>
                <Box className="grid grid-cols-[10rem,1fr]">
                  ...
                  <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                    {data?.findPlans.endDate
                      ? FormatDateTime(data.findPlans.endDate)
                      : ""}
                  </Typography>
                </Box>
                <Box className="grid grid-cols-[10rem,1fr]">
            ...
            <Box className="mt-5 border border-neutral-300 rounded-lg p-5">
              <Box className="!text-neutral20 !font-roboto !text-base !font-semibold !flex !items-center !gap-4 mb-5">
                Regras
                <Button
                  className="!min-w-5 !mr-5"
                  sx={{
              ...
              <>
                <Box className="grid grid-cols-[10rem,1fr]">
                  <Typography className="!text-neutral-700 !font-roboto !text-sm">
                    Frequência
                  </Typography>
                  <Typography className="!text-neutral-700 !font-roboto !text-sm !font-semibold">
                    <RulesFrequencyMapper
                      rules={{ frequency: data?.findPlans?.frequency || "" }}
                    />
                  </Typography>
                </Box>
                <Box className="grid grid-cols-[10rem,1fr]">
                  ...
                  <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                    <RulesAccessMapper
                      rules={{ access: data?.findPlans?.access || "" }}
                    />
                  </Typography>
                </Box>
                <Box className="grid grid-cols-[10rem,1fr]">
                ...
                {data?.findPlans.hours === "CUSTOM" && (
                  <Box className="flex flex-wrap justify-between mt-2">
                    {daysOfWeek.map(({ key, label }) => (
                      <Box
                        key={key}
                        className="bg-[#F3F3F4] md:w-[24%] w-full rounded-lg p-5 pt-[14px] mt-3"
                      >
                        <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 uppercase">
                          {label}
                        </Typography>
                        ...
                        {(formData[key] as string[]).map((slot, index) => (
                          <>
                            ...
                            >
                              <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-[.1rem] !font-semibold">
                                {slot}
                              </Typography>
                            </Box>
                            <Divider className="!my-3" />
            ...
            <Box className="mt-5 border border-neutral-300 rounded-lg p-5">
              ...
              <>
                <Box className="flex flex-wrap justify-between">
                  {Array.isArray(data?.findPlans?.modalities) &&
                  data.findPlans.modalities.length > 0 ? (
                    data.findPlans.modalities.map(
                      (
                        modality: {
                          name: any;
                          description: any;
                        ...
                        >
                          ...
                          <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                            {modality.amount !== null
                              ? `${new Intl.NumberFormat("pt-BR", {
                                  style: "currency",
                                  currency: "BRL",
                                }).format(modality.amount)}`
                              : ""}
                          </Typography>
                        </Box>
                      )
            ...
            <Box className="mt-5 border border-neutral-300 rounded-lg p-5">
              ...
              <>
                <Box className="flex flex-wrap justify-between">
                  {Array.isArray(data?.findPlans?.customServices) &&
                  data.findPlans.customServices.length > 0 ? (
                    data.findPlans.customServices.map(
                      (
                        customServices: {
                          name: any;
                          description: any;
                        ...
                        >
                          ...
                          <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                            {customServices.amount !== null
                              ? `${new Intl.NumberFormat("pt-BR", {
                                  style: "currency",
                                  currency: "BRL",
                                }).format(customServices.amount)}`
                              : ""}
                          </Typography>
                        </Box>
                      )
            ...
            <Box className="mt-5 border border-neutral-300 rounded-lg p-5">
              ...
              <>
                <Box className="flex flex-wrap justify-between">
                  {Array.isArray(data?.findPlans?.periodicities) &&
                  data.findPlans.periodicities.length > 0 ? (
                    data.findPlans.periodicities.map(
                      (
                        periodicity: {
                        ...
                        const totalCustomServiceAmount =
                          data.findPlans.customServices
                            .map(
                              (service: {
                                amount: string | number | undefined;
                        ...
                        const adjustedAmount =
                          parseToFloat(periodicity.amount) -
                        ...
                        return (
                          ...
                          >
                            ...
                            <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                              {periodicity.charge !== null
                                ? `R$ ${periodicity.charge}`
                                : ""}
                            </Typography>
                            <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4">
                              Juros por Atraso
                            ...
                            <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                              {periodicity.startDate
                                ? FormatDateTime(periodicity.startDate)
                                : ""}
                            </Typography>
                            <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4">
                              Fim da Vigência
                            ...
                            <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                              {periodicity.endDate
                                ? FormatDateTime(periodicity.endDate)
                                : ""}
                            </Typography>
                            <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4">
                              Observações

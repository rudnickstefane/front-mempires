...
export default function StudentsGymAdmin({
  enqueueSnackbar,
}: GymManagementProps) {
  const {
    itemsPerPage,
                          ...
                          .map((student, index) => (
                            ...
                            >
                              <TableCell>
                                <Switch
                                  checked={
                                    student.status === "ACTIVE" ? true : false
                                  }
                                  onClick={() =>
                                    handleStatusPlan(
                                      student.profileCode,
                              ...
                              <TableCell className="max-w-[10rem]">
                                <Box
                                  ...
                                  onClick={() =>
                                    handleMoreDetails(student.profileCode)
                                  }
                                  sx={{
                                    transition:
                              ...
                              <TableCell>
                                <Box textAlign="center">
                                  <IconButton
                                    ...
                                    onClick={(event) =>
                                      handleOpenMore(event, student.profileCode)
                                    }
                                    style={{
                                  ...
                                  <Menu
                                    ...
                                    open={Boolean(
                                      anchorEls[student.profileCode]
                                    )}
                                    onClose={() =>
                                      handleCloseMore(student.profileCode)
                                    }
                                    slotProps={{
                                      paper: {
                                        sx: {
                                  ...
                                  >
                                    ...
                                    <MenuItem
                                      onClick={() =>
                                        handleAlterStudent(student.profileCode)
                                      }
                                      sx={{
                                        borderRadius: ".4rem",
                                        margin: ".2rem 0",
                                        ...
                                        <Box className="bg-white rounded-lg w-[500px] flex flex-col items-center p-7">
                                          ...
                                          <Box className="bg-[#fef7e5] text-[#744600] p-5 rounded-3xl mt-5 text-[.9rem] w-full">
                                            ...
                                            <Typography className="!text-[.9rem]">
                                              Esta ação é irreversível e todos
                                              os dados associados a este aluno

            ...
            <Box className="mt-5 border border-neutral-300 rounded-lg p-5">
              ...
              <>
                ...
                <Box className="grid grid-cols-[10rem,1fr]">
                  ...
                  <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                    {data?.findClasses.startDate
                      ? FormatDateTime(data.findClasses.startDate)
                      : ""}
                  </Typography>
                </Box>
                <Box className="grid grid-cols-[10rem,1fr]">
                  ...
                  <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                    {data?.findClasses.endDate
                      ? FormatDateTime(data.findClasses.endDate)
                      : ""}
                  </Typography>
                </Box>
                <Box className="grid grid-cols-[10rem,1fr]">
            ...
            <Box className="mt-5 border border-neutral-300 rounded-lg p-5">
              ...
              <>
                ...
                <Box className="grid grid-cols-[13rem,1fr]">
                  ...
                  <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                    {data?.findClasses?.minimumAlert}
                  </Typography>
                </Box>
                <Box className="grid grid-cols-[10rem,1fr]">
                  <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4">
                    Horários para acesso
                  </Typography>
                </Box>
            ...
            <Box className="mt-5 border border-neutral-300 rounded-lg p-5">
              ...
              <>
                <Box className="flex flex-wrap justify-between">
                  {Array.isArray(data?.findClasses?.modalities) &&
                  data.findClasses.modalities.length > 0 ? (
                    data.findClasses.modalities.map(
                      (
                        modality: { name: any; description: any },

...
export const GymContributorDetails = ({
  ...
  const { isDrawerOpen, closeDrawerDetails, renderDrawerContent, openDrawer } =
                ...
                >
                  ...
                  {contact.emailStatus === "PENDING" ? (
                    <Tooltip
                      ...
                      title={
                        <>
                          Este e-mail ainda não foi confirmado. Clique para
                          reenviar o e-mail de confirmação.
                          <br />
                          <br />
                          Após o envio, não se esqueça de verificar sua caixa de

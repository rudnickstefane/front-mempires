...
import { SupplierRegisterDrawer } from "../../../../components/Drawer";
import { useVisitsGymAdmin } from "../../hooks";
import { AdminGymDrawerType } from "../../types";

export default function SuppliersGymAdmin() {
  {
    /* Drawers */
  }
          ...
          <Box className="bg-white w-full rounded-3xl shadow-md p-5 border border-[#EAECF0]">
            <Box className="flex flex-row justify-between items-center">
              ...
              <Button
                ...
                onClick={() => openDrawer("SupplierRegister")}
              >
                Novo Fornecedor
              </Button>
            </Box>
                            ...
                            <TableCell>
                              <Box className="!flex !flex-row items-center">
                                ...
                                visit.categories.length > 0 ? (
                                  <>
                                    <Box className="max-w-[10rem] truncate">
                            ...
                            <TableCell>
                              <Box textAlign="center">
                                <IconButton
                                  ...
                                  onClick={(event) =>
                                    handleOpenMore(event, visit.visitCode)
                                  }
                                  style={{
                                    backgroundColor: isMenuOpen(visit.visitCode)
                                      ? "#0000000a"
                                      : "",
                                  }}
                                >
                                ...
                                <Menu
                                  ...
                                  onClose={() =>
                                    handleCloseMore(visit.visitCode)
                                  }
                                  slotProps={{
                                    paper: {
                                      sx: {
                                ...
                                >
                                  ...
                                  <MenuItem
                                    onClick={() =>
                                      handleAlterVisit(visit.visitCode)
                                    }
                                    sx={{
                                      borderRadius: ".4rem",
                                      margin: ".2rem 0",
                                  ...
                                  <MenuItem
                                    ...
                                    style={{
                                      backgroundColor: modalConfirmDelete
                                        ? "#0000000a"
                                        : "",
                                    }}
                                  >
                                      ...
                                      <Box className="bg-white rounded-lg w-[500px] flex flex-col items-center p-7">
                                        ...
                                        <Box className="bg-[#fef7e5] text-[#744600] p-5 rounded-3xl mt-5 text-[.9rem] w-full">
                                          ...
                                          <Typography className="!text-[.9rem]">
                                            Esta ação é irreversível e todos os
                                            dados associados a este visitante
                                        ...
                                        <Box className="flex flex-row justify-between mt-8 w-full">
                                          ...
                                          <Button
                                            ...
                                            onClick={() =>
                                              handleDeletePlan(visit.visitCode)
                                            }
                                          >
                                            Excluir
                                          </Button>

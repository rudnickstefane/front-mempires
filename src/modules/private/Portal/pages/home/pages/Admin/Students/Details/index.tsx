...
export const GymStudentDetails = ({
  ...
  const selectedReferral = referralSourceOptions.find(
    (option) => option.value === data.referralSource
  );
        ...
        <Box className="flex flex-row items-center">
          ...
          <Box className="w-full md:mt-0 mt-5">
            <Typography className="flex flex-row items-center !text-[2.25rem] text-[#212121]">
              <>
                <Box className="truncate max-w-[55vw]">{data.name}</Box>
              </>
            </Typography>
          ...
          <Box className="bg-white w-full rounded-3xl shadow-md p-5 border border-[#EAECF0]">
            ...
            <Box className="mt-5 flex flex-row">
              {detailsViews.map((detail) => {
                ...
                return (
                  <Box key={detail.view} className="mr-5">
                    <Button
                      ...
                      <Box className="mt-5 border border-neutral-300 rounded-lg p-5">
                        ...
                        <>
                          ...
                          <Box className="grid grid-cols-[10.5rem,1fr]">
                            ...
                            <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                              {data?.stateMarital === "MARRIED"
                                ? "Casado"
                                : data?.stateMarital === "SINGLE"
                                ? "Solteiro"
                                : data?.stateMarital
                                ? "Outros"
                                : ""}
                            ...
                            <Box className="flex flex-col gap-4 p-6 bg-neutral-100 rounded-xl mt-5">
                              <Box className="flex flex-row">
                                <Box className="flex flex-col flex-grow">
                                  <Typography className="text-left !font-roboto !text-sm">
                                    Indicado por:
                                  </Typography>
                      ...
                      <Box className="mt-5 border border-neutral-300 rounded-lg p-5 pb-0">
                        ...
                        <Box className="flex flex-wrap justify-between">
                          {data?.contact
                            ...
                            .map(
                              (contact: {
                                contactCode: Key | null | undefined;
                                description: any;
                                phone: any;
                                emailStatus: string;
                                email: any;
                                    ...
                                    <Tooltip
                                      ...
                                      title={
                                        <>
                                          ...
                                          Clique para reenviar o e-mail de
                                          confirmação.
                                          <br />
                                          <br />
                                          Após o envio, não se esqueça de
                                          verificar sua caixa de entrada e a
                                          pasta de spam.
                                        </>
                                      }
                                      arrow
                    ...
                    <>
                      <Box className="flex items-center gap-4 my-10">
                        <Box className="flex flex-row items-center">
                          ...
                          <Box>
                            <Box className="flex flex-row items-end text-[#ff0336]">
                              R${" "}
                              <Box className="ml-1 text-3xl">
                                {responseTransactions?.findTransactions[0]
                                  .rewardsCredit
                                  ? responseTransactions?.findTransactions[0]
                                      .rewardsCredit
                                  : "0,00"}
                                <Tooltip
                                  title={
                                    <>
                                      iFlex Rewards trata-se de um crédito que
                                      pode ser utilizado para abater o valor das
                                      próximas mensalidades ou para a compra de
                                      produtos em nossa plataforma.
                                    </>
                                  }
                                  placement="right"
                                  arrow
                        ...
                        <Box className="flex flex-row items-center ml-1">
                          {pendingTotal > 0 ? (
                            <>
                              ...
                              <Box>
                                <Box className="flex flex-row items-end text-[#d23a01]">
                                  R${" "}
                                  <Box className="ml-1 text-3xl">
                            ...
                            <>
                              ...
                              <Box>
                                <Box className="flex flex-row items-end text-[#16ae49]">
                                  Não existem
                                </Box>
                                <Typography>pagamentos em aberto</Typography>
                              </Box>
                        ...
                        <Box className="my-5">
                          <Box className="w-[40%] relative">
                            ...
                            <Select
                              ...
                              value={filterStatusOptions.filter((option) =>
                                ...
                                transactions
                                  ...
                                  .map((transaction, index) => (
                                    <TableRow
                                      ...
                                      sx={{
                                        transition:
                                          "transform 0.3s, background-color 0.3s, border-color 0.3s ease",
                                    ...
                                    >
                                      <TableCell>
                                        TRA-{transaction.transactionCode}
                                      </TableCell>
                                                ...
                                                >
                                                  ...
                                                  >
                                                    <Box className="bg-white rounded-lg w-[500px] flex flex-col items-center p-7">
                                                      ...
                                                      <Typography className="text-center !text-[1.2rem] !mt-5">
                                                        Deseja reprocessar a
                                                        transação{" "}
                                                        {
                                                          transaction.description
                                                        }
                                                      ...
                                                      <Box className="bg-[#edf5ff] text-[#4b5563] p-5 rounded-3xl mt-5 text-[.9rem] w-full">
                                                        ...
                                                        <Typography className="!text-[.9rem]">
                                                          Caso o prazo de
                                                          pagamento tenha sido
                                                          ultrapassado, a data
                                                          será atualizada para
                                                          hoje. Multa e juros
                                                          serão desconsiderados,
                                                          pois o pagamento não
                                                          foi processado devido
                                                          a falhas no sistema.
                                                        </Typography>
                                                      </Box>
                                                  ...
                                                  <Fade in={modalConfirmCancel}>
                                                    <Box className="bg-white rounded-lg w-[500px] flex flex-col items-center p-7">
                                                      ...
                                                      <Box className="bg-[#edf5ff] text-[#4b5563] p-5 rounded-3xl mt-5 text-[.9rem] w-full">
                                                        ...
                                                        <Typography className="!text-[.9rem]">
                                                          Após o cancelamento a
                                                          transação não ficará
                                                  ...
                                                  <Fade in={modalConfirmDelete}>
                                                    <Box className="bg-white rounded-lg w-[500px] flex flex-col items-center p-7">
                                                      ...
                                                      <Box className="bg-[#fef7e5] text-[#744600] p-5 rounded-3xl mt-5 text-[.9rem] w-full">
                                                        ...
                                                        <Typography className="!text-[.9rem]">
                                                          Esta ação é
                                                          irreversível e todos
                                                          os dados associados a
                                                          esta transação serão
                                                          permanentemente
                                                          removidos.
                                                        </Typography>
                                                      </Box>
                      ...
                      <Box className="overflow-x-auto border border-neutral-300 rounded-lg w-full">
                                ...
                                studentPlans
                                  ...
                                  .map((plan, index) => (
                                    ...
                                    >
                                      ...
                                      <TableCell>
                                        {plan.periodicityName}
                                      </TableCell>
                                      <TableCell>R$ {plan.amount}</TableCell>
                                      <TableCell>
                                        <PaymentBadge
                                          payment={plan.planPayment}
                                        />
                                      </TableCell>
                                      <TableCell className="!text-center">
                                        {plan.createdAt}
                                      ...
                                      <TableCell>
                                        <Box textAlign="center">
                                          ...
                                          <Menu
                                            anchorEl={
                                              anchorEls[plan.studentPlanCode]
                                            }
                                            open={Boolean(
                                              anchorEls[plan.studentPlanCode]
                                            )}
                        ...
                        <Box className="flex justify-between items-center px-6 py-3 border-l border-r border-b border-[#EAECF0] rounded-b-lg">
                          ...
                          <Box className="flex items-center gap-2">
                            ...
                            <Typography variant="body2">
                              {startIndexPlans + 1} -{" "}
                              {Math.min(endIndexPlans, totalItemsPlans)} de{" "}
                  ...
                  return (
                    <>
                      <Box className="flex flex-col items-center mb-5">
                        <Box className="text-[#E94560] text-[2.5rem] mb-3">
                          Oops!
                        </Box>
                        <Typography>
                      ...
                      <Box className="overflow-x-auto border border-neutral-300 rounded-lg w-full">
                                    ...
                                    >
                                      ...
                                      <TableCell>
                                        <Box textAlign="center">
                                          ...
                                          <Menu
                                            anchorEl={
                                              anchorEls[review.reviewCode]
                                            }
                                            open={Boolean(
                                              anchorEls[review.reviewCode]
                                            )}
                                            onClose={() =>
                                              handleCloseMore(review.reviewCode)
                                            }
                                            slotProps={{
                                              paper: {
                                                sx: {
                        ...
                        <Box className="flex justify-between items-center px-6 py-3 border-l border-r border-b border-[#EAECF0] rounded-b-lg">
                          ...
                          <Box className="flex items-center gap-2">
                            ...
                            <Typography variant="body2">
                              {startIndexReviews + 1} -{" "}
                              {Math.min(endIndexReviews, totalItemsReviews)} de{" "}

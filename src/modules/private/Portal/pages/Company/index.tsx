...
export default function CompanyDetailsManagement({
  data,
  refresh,
  isCompanyLoading,
  permissions,
          ...
          <Box className="bg-white w-full rounded-3xl shadow-md p-5 border border-[#EAECF0]">
                ...
                <>
                  <Box className="grid grid-cols-[10rem,1fr]">
                    ...
                    <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                      {data?.findCompanyDetails.code
                        ? FormatCode(data?.findCompanyDetails.code)
                        : ""}
                    </Typography>
                  </Box>
                  <Box className="grid grid-cols-[10rem,1fr]">
                  ...
                  <Box className="grid grid-cols-[10rem,1fr]">
                    ...
                    <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                      {data?.findCompanyDetails.startDate || ""}
                    </Typography>
                  </Box>
                  <Box className="grid grid-cols-[10rem,1fr]">
                    <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4">
                    ...
                    <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                      {data?.findCompanyDetails.endDate || ""}
                    </Typography>
                  </Box>
                </>
              )}
              ...
              {isCompanyLoading ? (
                ...
                <>
                  ...
                  <Box className="grid grid-cols-[10rem,1fr]">
                    ...
                    <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                      {data?.findCompanyDetails.address || ""}
                    </Typography>
                  </Box>
                  <Box className="grid grid-cols-[10rem,1fr]">
                    <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4">
                    ...
                    <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                      {data?.findCompanyDetails.number || ""}
                    </Typography>
                  </Box>
                  <Box className="grid grid-cols-[10rem,1fr]">
                    <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4">
                    ...
                    <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                      {data?.findCompanyDetails.complement || ""}
                    </Typography>
                  </Box>
                  <Box className="grid grid-cols-[10rem,1fr]">
                    <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4">
                    ...
                    <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4 !font-semibold">
                      {data?.findCompanyDetails.district || ""}
                    </Typography>
                  </Box>
                  <Box className="grid grid-cols-[10rem,1fr]">
                    <Typography className="!text-neutral-700 !font-roboto !text-sm !mt-4">
            ...
            <Box className="mt-5 border border-neutral-300 rounded-lg p-5 pb-0">
              <Box className="!text-neutral20 !font-roboto text-base font-semibold flex md:items-center !gap-4 mb-3 md:flex-row flex-col justify-between">
                ...
                {data &&
                  data.findCompanyDetails?.contact?.filter(

...
export const useGymManagement = ({ permissions }: ManagementProps) => {
  ...
  const findGymMenus = useCallback(async () => {
    ...
    try {
      ...
      enqueueSnackbar("Tivemos um problema ao exibir os menus.", {
        variant: "error",
      });
    }
  ...
  const findCompanyDetails = useCallback(async () => {
    ...
    try {
      ...
      enqueueSnackbar("Ocorreu um erro ao buscar as informações da academia.", {
        variant: "error",
      });
    }
  ...
  const findNotifications = useCallback(async () => {
    try {
      ...
      enqueueSnackbar("Ocorreu um erro ao buscar as notificações.", {
        variant: "error",
      });
    }
  ...
  const finishSession = () => {
    // localStorage.clear();
    enqueueSnackbar("Sua sessão foi encerrada com sucesso. Até logo!", {
      variant: "success",
    });
    navigate("/entrar");
  };
      ...
      case "Company":
        return (
          <CompanyDetailsManagement
            data={responseCompanyDetails}
            refresh={() => refresh("findCompanyDetails")}
              ...
              <Box className="flex flex-col">
                ...
                <Box className="flex flex-col mt-5">
                  <Typography>
                    ...
                    temporariamente indisponível devido a uma manutenção
                    programada.
                  </Typography>
                  <Typography>
                    Nosso time está trabalhando para restabelecer o acesso o
                    mais rápido possível.
                  </Typography>
                  <Typography className="!mt-5">
                    Caso você acredite que deveria ter acesso, por favor, entre

...
import { useContributorsGymAdmin } from '../../hooks';
...
export default function ContributorsGymAdmin() {
    ...
    const {
        ...
        openDrawer,
        handleStatusPlan
    } = useContributorsGymAdmin({ enqueueSnackbar });
                ...
                <Box className='flex flex-row justify-between items-center'>
                    <Box>
                        ...
                        <Typography className='flex flex-row items-center !text-[.85rem] !mt-4'>
                            Administrativo<MdKeyboardArrowRight className='mx-1.5'/>Configurações<MdKeyboardArrowRight className='mx-1.5'/>Colaboradores
                        </Typography>
                    </Box>
                    <Button
                        ...
                        onClick={() => openDrawer('ContributorRegister')}
                ...
                <Box className="overflow-x-auto border border-neutral-300 rounded-lg w-full">
                    <TableContainer>
                        <Table>
                            ...
                            <TableBody>
                            {contributorsToDisplay && contributorsToDisplay.length > 0 ? (
                                contributorsToDisplay.sort((a, b) => 
                                ...
                                >
                                    <TableCell>
                                        <Switch
                                            checked={contributor.status === 'ACTIVE' ? true : false}
                                            onClick={() => handleStatusPlan(contributor.profileCode, contributor.status)}
                                        />
                                    </TableCell>
                                    <TableCell className="max-w-[10rem]">
                                        <Box
                                            className='cursor-pointer color-primary hover:!text-red-600 whitespace-nowrap overflow-hidden text-ellipsis'
                                            onClick={() => handleMoreDetails(contributor.profileCode)}
                                            sx={{
                                                transition: "transform 0.3s, background-color 0.3s",
                                            }}
                                        >
                                    ...
                                    <TableCell className="max-w-[10rem]">
                                        ...
                                        >
                                            <PositionBadge payment={contributor.position} />
                                        </Box>
                                    </TableCell>
                                    <TableCell>{contributor.groupName}</TableCell>
                                    <TableCell>
                                        <Box textAlign="center">
                                            <IconButton
                                                className='w-[2rem] h-[2rem]'
                                                onClick={(event) => handleOpenMore(event, contributor.profileCode)}
                                                style={{
                                                    backgroundColor: isMenuOpen(contributor.profileCode) ? '#0000000a' : '',
                                                }}
                                            >
                                                <MoreHorizIcon />
                                            </IconButton>
                                            <Menu
                                                anchorEl={anchorEls[contributor.profileCode]}
                                                open={Boolean(anchorEls[contributor.profileCode])}
                                                onClose={() => handleCloseMore(contributor.profileCode)}
                                                slotProps={{
                                                    paper: {
                                                        sx: {
                                                            borderRadius: '.7rem',
                                            ...
                                            >
                                                ...
                                                <MenuItem
                                                    onClick={() => handleAlterContributor(contributor.profileCode)}
                                                    sx={{
                                                        borderRadius: '.4rem',
                                                        margin: '.2rem 0',
                                                        '&:hover': {
                                                ...
                                                >
                                                    <Fade in={modalConfirmDelete}>
                                                        <Box className="bg-white rounded-lg w-[500px] flex flex-col items-center p-7">
                                                            ...
                                                            <Typography className='text-center !text-[1.2rem] !mt-5'>Deseja excluir {contributor.name}?</Typography>
                                                            ...
                                                            <Box className='flex flex-row justify-between mt-8 w-full'>
                                                                ...
                                                                <Button
                                                                    ...
                                                                    onClick={() => handleDeletePlan(contributor.profileCode)}
                                                                >
                                                                    Excluir
                                                                </Button>
                                                            </Box>

...
import { MdKeyboardArrowRight, MdOutlineContacts } from 'react-icons/md';
import { ContactCreateDrawer } from '../../../../../components/Drawer';
...
export default function ContactsGymAdmin() {
    ...
    const renderDrawerContent = () => {
        switch (drawerType) {
            case 'ContactCreate':
                return <ContactCreateDrawer closeDrawer={closeDrawer} enqueueSnackbar={enqueueSnackbar}/>;
        ...
        <Box>
            ...
            <Box className='flex flex-row justify-between items-center'>
                ...
                <Button
                    ...
                    onClick={() => openDrawer('ContactCreate')}
                >Novo Contato</Button>
            </Box>

...
const iconMap: Record<string, React.ElementType> = {
  ...
  LuAlertCircle: FiAlertTriangle,
  FiInfo: FiInfo,
  Plan: FiAlertTriangle,
    ...
    <Box className="overflow-x-auto max-h-[calc(100vh-60px)] p-5 pb-[4rem]">
      ...
      <Box className="flex flex-row w-full">
        <Box className="bg-white w-full rounded-3xl shadow-md p-5 border border-[#EAECF0] mr-5">
          <Typography className="text-[#152c5b]">
            Pagamentos a receber
            <Tooltip
              title={
                <>
                  Esses valores pendentes incluem as vendas de seus produtos no
                  nosso Marketplace e as taxas configuradas pela sua academia
                  para o uso de serviços de personal trainers e nutricionistas.
                  <br />
                  <br />
                  Se sua academia configurou uma taxa, ela será recebida como
                  repasse referente aos serviços prestados aos seus alunos.
                  <br />
                  <br />
          ...
          <Typography className="!text-[.9rem]">
            Markeplace & serviços de personal trainers e nutricionistas.
          </Typography>
        </Box>
            ...
            <Tooltip
              title={
                <>
                  Novas Matrículas. <br />
                  <br />
                  O percentual indica a diferença no número de matrículas em
                  relação ao mês anterior. <br />
                  <br />
                  Se o valor é positivo, significa que tivemos mais matrículas
                  do que no mês passado. <br />
                  <br />
                  Se for negativo, significa que o número de novas matrículas
                  diminuiu. <br />
                  <br />
                  Para mais detalhes, acesse no menu: <br />
            ...
            <Tooltip
              title={
                <>
                  Novos Visitantes. <br />
                  <br />
                  O percentual indica a diferença no número de visitantes em
                  relação aos últimos 30 dias. <br />
                  Se o valor é positivo, significa que tivemos mais visitantes
                  que no mês passado. <br />
                  Se for negativo, significa que o número de visitantes
                  diminuiu. <br />
                  <br />
                  Para mais detalhes, acesse no menu: <br />
            ...
            <Box className="flex flex-row items-end">
              {isLoadingStudentMetrics ? (
                ...
                <>
                  ...
                  <Typography className="text-[#fd6d3f] !font-bold !ml-2">
                    + 0.00%
                  </Typography>
                </>
              )}
        ...
        <Box className="flex flex-col w-full mr-5">
          <Box className="flex flex-row w-full">
            <Box className="flex flex-row w-full">
              ...
              >
                <Box>
                  <FaUserCheck className="text-[2.5rem] text-[#ff0336] bg-[#fff0f3] p-2 rounded-full" />
                </Box>
            ...
            {isLoadingShortcuts ? (
              <>
                <Button
                  className="bg-white w-full h-[80px] !rounded-3xl items-center justify-center flex flex-row !font-normal !border-dashed !border-[1px] !mx-4"
                  disabled
                >
                  <Skeleton
                    variant="circular"
                    className="!w-[2.50rem] !h-[2.50rem]"
                    animation="wave"
                  />
                  <Skeleton
                    variant="text"
                    className="!w-[6rem] !ml-2"
                    animation="wave"
                  />
                </Button>
                <Button
              ...
              <>
                {Array.isArray(responseShortcuts?.findUserShortcuts) &&
                responseShortcuts.findUserShortcuts.length > 0 ? (
                  <>
                    {responseShortcuts.findUserShortcuts.map(
                      (shortcut, index) => (
                        <Box
                        ...
                        >
                          ...
                          >
                            <Button
                              ...
                              onClick={() =>
                                handleDeleteShortcut(shortcut.shortcutCode)
                              }
                            >
          ...
          <Box className="mt-5 flex flex-col w-full bg-white !rounded-3xl shadow-md h-[240px] !border !border-[#EAECF0]">
            {isLoadingSlides ? (
              ...
              <>
                {responseSlides?.findSlides &&
                  Array.isArray(responseSlides.findSlides) && (
                    <Carousel
                      autoSlide={true}
            ...
            <Box className="bg-white w-full rounded-3xl shadow-md p-5 border border-[#EAECF0]">
              <Typography className="text-[#152c5b]">
                ...
                <Tooltip
                  title={
                    <>
                      São os alunos com matrículas ativas até este momento.{" "}
                      <br />
                      <br />
                      Para mais detalhes, acesse no menu: <br />
                      <b>Administrativo &gt; Alunos</b>
            ...
            <Box className="bg-white w-full rounded-3xl shadow-md p-5 border border-[#EAECF0] mx-5">
              <Typography className="text-[#152c5b]">
                ...
                <Tooltip
                  title={
                    <>
                      <b>Rematrículas ou renovações:</b>
                      <br />
                      <br />
                      Alunos que renovaram um plano existente ou retornaram após
                      um período de ausência. <br />
                      <br />
                      Para mais detalhes, acesse no menu: <br />
                      <b>Administrativo &gt; Alunos</b>
                    </>
            ...
            <Box className="bg-white w-full rounded-3xl shadow-md p-5 border border-[#EAECF0]">
              <Typography className="text-[#152c5b]">
                ...
                <Tooltip
                  title={
                    <>
                      Alunos que cancelaram suas matrículas. <br />
                      <br />
                      Para mais detalhes, acesse no menu: <br />
                      <b>Administrativo &gt; Alunos</b>
                    </>
          ...
          <Box className="bg-white rounded-3xl shadow-md w-full mt-5 p-5">
            <Box className="color-secondary text-[1.3rem] mb-5">
          ...
          <Box className="bg-white rounded-3xl shadow-md w-full border border-[#EAECF0]">
            <Box className="mt-5">
              <Box className="flex flex-row justify-between mx-5 mb-3">
                <Box className="color-secondary text-[1.3rem]">
                  Pagamentos Pendentes
                </Box>
                    ...
                    <Box key={index} className="flex flex-col">
                      <Button
                        ...
                        sx={{
                          ...
                          padding: 0,
                          transition:
                            "transform 0.3s, background-color 0.3s, color 0.3s, transform .5s;",
                          "&:hover": {
                            background: "#f3f3f3",
                      ...
                      >
                        ...
                        <Box>
                          <Box className="font-poppins font-semibold">
                            {payment.name}
                          </Box>

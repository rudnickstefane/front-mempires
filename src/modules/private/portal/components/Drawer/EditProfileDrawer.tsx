    ...
    <Box>
      <Box className="flex justify-between">
        ...
        <Box className="flex justify-end items-center">
          ...
          <Typography className="!text-[.8rem] !absolute right-[2rem] top-[4.7rem] text-gray-500">
            (<span className="text-[#ff0000]">*</span>) Campos Obrigatórios
          </Typography>
        </Box>
      </Box>
          ...
          <Box className="min-w-[200px] mr-[24px]">
            {dynamicSteps.map((step, index) => (
              <Box
                ...
                sx={{
                  backgroundColor:
                    activeStep === index ? "#f3f3f4" : "transparent",
                    ...
                    <>
                      ...
                      <Box className="flex flex-row items-center">
                        ...
                        <Tooltip
                          title={
                            <>
                              O CPF só pode ser alterado uma vez. Alterações
                              subsequentes precisam ser solicitadas ao suporte.
                              <br />
                              <br />

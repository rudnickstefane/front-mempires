...
export const ValidateFormPlanAlter= (
  ...
  switch (activeStep) {
    case 0: {
      if (!formData.name) {
        errors.nameError = 'O nome do plano é obrigatórios.';
      }
      ...
      if (formData.startDate && formData.endDate) {
        ...
        if (endDate < startDate) {
          errors.endDateError = 'A data de fim não pode ser anterior à data de início.';
        }
      }

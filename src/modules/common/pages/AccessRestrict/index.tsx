...
export const AccessRestrict: React.FC<AccessRestrictProps> = ({
  isAuthorized,
  children,
}) => {
  ...
  if (loading)
    return (
      <Box className="w-full absolute flex flex-col justify-center items-center h-full">
        ...
        <LinearProgress className="!bg-[var(--color-primary-medial)] absolute w-28 rounded-xl" />
      </Box>
    );
        ...
        <Box className="flex flex-row w-[70%] justify-between items-center">
          <Box className="flex flex-col">
            ...
            <Box className="flex flex-col mt-5">
              <Typography>
                Lamentamos, mas o acesso a esta área está restrito no momento.
              </Typography>
              <Typography>
                O conteúdo que você está tentando acessar está disponível apenas
                para usuários autorizados ou requer permissões especiais.
              </Typography>

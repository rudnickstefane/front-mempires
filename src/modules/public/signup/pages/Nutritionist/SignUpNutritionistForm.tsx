...
import { useSignUpNutritionistForm } from './hooks';

export const SignUpNutritionistForm = ({
    enqueueSnackbar
  }: SignUpProps) => {
    ...
    const {
        ...
        handleContinue,
        handleFinish
      } = useSignUpNutritionistForm({ enqueueSnackbar });
                        ...
                        <>
                         <Box className='w-[500px] rounded-lg p-10 shadow-lg bg-white items-center flex flex-col'>
                            <Box className='flex flex-col justify-center items-center'>
                                <Typography className='!text-3xl !text-[#333333]'>Nutricionista</Typography>

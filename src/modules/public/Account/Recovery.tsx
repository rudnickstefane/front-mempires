        ...
        <Box className="flex flex-col justify-center items-center w-full px-14">
          <Link to="/">
            <Box className="flex w-[161px] items-center !-ml-5">
              ...
              <Box className="ml-3 text-[2rem] color-primary font-intro mt-[.34rem]">
                iFlex
              </Box>
            </Box>
          </Link>
          {!emailSent ? (
            <>
              <Box className="flex items-center justify-center flex-col mt-5">
                <Typography className="!text-3xl text-gray !-ml-3">
                  Recuperar acesso
                </Typography>
                <Typography className="!mt-4 !text-sm !text-gray-700 text-center">
                  Informe o CNPJ, CPF, E-mail ou nome de usuário associado à sua
                  conta iFlex Fit.
                </Typography>
              </Box>
              ...
              <Typography className="!mt-4 !text-sm !text-gray-700 text-center">
                Enviaremos instruções para recuperar seu acesso.
              </Typography>
            </>
          ) : (
            <>
              <Box className="flex items-center justify-center flex-col mt-3">
                ...
                <Typography className="!text-2xl text-gray text-center !mt-5">
                  Verifique seu e-mail
                </Typography>
                <Typography className="!mt-4 !text-[1rem] !text-gray-700 text-center">
                  Enviamos instruções para recuperar seu acesso.
                </Typography>
                <Typography className="!text-[1rem] !text-gray-700 text-center">
        ...
        <Box className="flex items-center h-full absolute top-0">
          <Box className="flex flex-col ml-[5rem] w-[450px]">
            <Box className="flex flex-row font-intro md:text-[2.5rem] text-[.6rem] text-white uppercase items-center">
              Descubra em um só lugar toda a agilidade e facilitade dos serviços
              na
            </Box>
            <Box

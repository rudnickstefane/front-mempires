...
import { useSignUpSupplierForm } from './hooks';

export const SignUpSupplierForm = ({
    enqueueSnackbar
  }: SignUpProps) => {
    ...
    const {
        ...
        handleContinue,
        handleFinish
      } = useSignUpSupplierForm({ enqueueSnackbar });
                        ...
                        <>
                         <Box className='w-[500px] rounded-lg p-10 shadow-lg bg-white items-center flex flex-col'>
                            <Box className='flex flex-col justify-center items-center'>
                                <Typography className='!text-3xl !text-[#333333]'>Fornecedor</Typography>

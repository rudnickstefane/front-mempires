            ...
            <Box className="flex flex-col md:flex-row justify-center items-start py-32 px-20 pb-10 w-full">
                <Box className="mb-6 md:mb-0 mx-5">
                    ...
                    <Box className="flex mt-7 space-x-4">
                        <a href="https://facebook.com/iflexfit" target="_blank" rel="noopener noreferrer" className="text-[#646464] hover:text-white bg-[#efefef] p-3 rounded-full hover:bg-[#ff0336] transition-colors duration-300"><FaFacebookF size={17} /></a>
                        <a href="https://twitter.com/iflexfit" target="_blank" rel="noopener noreferrer" className="text-[#646464] hover:text-white bg-[#efefef] p-3 rounded-full hover:bg-[#ff0336] transition-colors duration-300"><FaXTwitter size={17} /></a>
                        <a href="https://linkedin.com/company/iflexfit" target="_blank" rel="noopener noreferrer" className="text-[#646464] hover:text-white bg-[#efefef] p-3 rounded-full hover:bg-[#ff0336] transition-colors duration-300"><FaLinkedinIn size={17} /></a>
                        <a href="https://youtube.com/iflexfit" target="_blank" rel="noopener noreferrer" className="text-[#646464] hover:text-white bg-[#efefef] p-3 rounded-full hover:bg-[#ff0336] transition-colors duration-300"><FaYoutube size={17} /></a>
                        <a href="https://instagram.com/iflexfit" target="_blank" rel="noopener noreferrer" className="text-[#646464] hover:text-white bg-[#efefef] p-3 rounded-full hover:bg-[#ff0336] transition-colors duration-300"><FaInstagram size={17} /></a>
                    </Box>
                </Box>
                <Box className="mb-6 md:mb-0 md:mx-7">
                    ...
                    <ul className="mt-5 space-y-2 leading-8">
                        <li><a href="/work" className='text-[#646464] hover:text-[#ff0336] transition-colors duration-300'>Carreiras</a></li>
                ...
                <Box className="mb-6 md:mb-0 md:mx-10">
                    ...
                    <ul className="mt-5 space-y-2 leading-8">
                        ...
                        <li><a href="/incentivo" className='text-[#646464] hover:text-[#ff0336] transition-colors duration-300'>Programas de Incentivo</a></li>
                ...
                <Box className="mb-6 md:mb-0">
                    ...
                    <a href="https://wa.me/5521975025087?text=Ol%C3%A1%2C%20encontrei%20o%20site%20iFlex%20e%20tenho%20algumas%20d%C3%BAvidas." target="_blank" className="mt-2 text-[#212121] flex text-[24px] items-center font-semibold hover:text-[#ff0336] transition-colors duration-300"><FaWhatsapp size={25} className='color-primary mr-2' /> 21 9 7502-5087</a>
                    <a href='mailto:contato@iflex.fit' className="mt-2 text-[#646464] flex items-center hover:text-[#ff0336] transition-colors duration-300">contato@iflexfit.com.br</a>
                </Box>
            </Box>

...
import { validationMessages } from "@sr/common/constants";
...
export function TextFieldComponent({
  ...
  const hasEndContent =
    showButton || (field.value && !options) || showPasswordToggle || endIcon;
  ...
  const getErrorMessage = () => {
    ...
    const errorMap: Record<string, string> = {
      ...
      "invalid-email": validationMessages.invalidEmail,
    };

    return errorMap[meta.error as string] || meta.error;
  };
        ...
        label={
          props.label
            ? intl.formatMessage({
                ...
                defaultMessage: props.label as string,
              })
            : undefined
        }

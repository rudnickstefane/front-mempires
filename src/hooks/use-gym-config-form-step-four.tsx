...
export const useGymConfigFormStepFour = (formData: StepFourProps['formData'], setFormData: StepFourProps['setFormData']) => {
    ...
    const handleCheckboxChange = (event: React.ChangeEvent<HTMLInputElement>, name: string) => {
        ...
        if (isChecked) {
            setFormData({
                ...formData,
                selectedModalities: [...selectedModalities, name],
            });
        } else {
            setFormData({
                ...formData,
                selectedModalities: selectedModalities.filter((modality: string) => modality !== name),
            });
        }
    };
